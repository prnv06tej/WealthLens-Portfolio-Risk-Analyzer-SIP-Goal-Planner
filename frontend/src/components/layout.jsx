...
export default function Layout() {
    ...
    return (
        <div style={{ display: 'flex', height: '100vh', width: '100vw', background: '#f8fafc', overflow: 'hidden' }}>
            ...
            <div style={{ width: '260px', background: '#0f172a', color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '24px 16px', boxSizing: 'border-box', flexShrink: 0 }}>
                <div>
                ...
                <div style={{ paddingTop: '15px', borderTop: '1px solid #1e293b', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    <div style={{ padding: '0 8px' }}>
                        <div style={{ fontSize: '0.9rem', fontWeight: '600', color: '#f8fafc' }}>
                            {user?.firstName ? `${user.firstName} ${user.lastName || ''}` : 'Investor Profile'}
                        </div>
                    ...
                    <button 
                        ...
                        style={{ 
                            ...
                            textAlign: 'left', fontWeight: '600', borderRadius: '6px' 
                        }}
                    >
                        <LogOut size={18} />
                        Exit Session
